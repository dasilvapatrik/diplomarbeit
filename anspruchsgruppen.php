<section id="anspruchsgruppen" class="bg-gray">
        <div class="container">
            <div class="row">
                <!-- <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Anspruchsgruppen Titel</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3> <div class="wow bounceInDown" data-wow-duration="1s" data-wow-iteration="1" data-wow-delay="0.3s"></div>
                </div>-->
            </div>
